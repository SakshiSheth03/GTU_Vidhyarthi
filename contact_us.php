...
<div id="d2">
        <div style="text-align:center; font-size:20px; font-weight:bold;">------ GTU Handles -----</div>
        <br>
        <a class="logo" href="https://www.instagram.com/gtumedia/?hl=en" target="_blank"><img class="logo" src="insta.jpg" alt="instagram logo">
        </a>
